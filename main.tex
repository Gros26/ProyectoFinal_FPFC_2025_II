...
\toprule
Dataset & Ruta & Vuelos & Itinerarios & T. secuencial & T. paralelo & Speedup \\
 & (cod1$\to$cod2) & & encontrados & (ms) & (ms) & \\
\midrule
\endfirsthead
...
% Ejemplos del curso
Curso-A1 & CTG$\to$PTY & 16 & 1 & 75.390 & 1898.990 & 0.04x \\
Curso-A2 & MAD$\to$SVO & 16 & 2 & 37.900 & 1794.220 & 0.02x \\
Curso-A3 & CLO$\to$SVO & 16 & 1 & 146.210 & 2341.740 & 0.06x \\
\midrule

% Dataset A1 (15 vuelos)
A1-1 & HOU$\to$MSY & 15 & 5 & 46.920 & 2224.320 & 0.02x \\
A1-2 & MSY$\to$BNA & 15 & 1 & 22.560 & 1257.870 & 0.02x \\
A1-3 & DFW$\to$ORD & 15 & 1 & 14.670 & 945.390 & 0.02x \\
\midrule

% Dataset A2
A2-1 & DFW$\to$ORD & 15 & 1 & 62.000 & 1099.620 & 0.06x \\
A2-2 & SFO$\to$BNA & 15 & 0 & 23.620 & 16.800 & 1.41x \\
A2-3 & PHX$\to$LAX & 15 & 1 & 11.020 & 757.560 & 0.01x \\
\midrule

% Dataset A3
A3-1 & MIA$\to$HOU & 15 & 1 & 10.230 & 755.060 & 0.01x \\
A3-2 & LAX$\to$MIA & 15 & 1 & 6.430 & 406.860 & 0.02x \\
A3-3 & DFW$\to$SFO & 15 & 1 & 12.470 & 442.170 & 0.03x \\
\midrule

% Dataset B1 (40 vuelos)
B1-1 & DFW$\to$ORD & 40 & 2 & 315.250 & 1713.430 & 0.18x \\
B1-2 & DFW$\to$DCA & 40 & 1 & 373.800 & 2151.940 & 0.17x \\
B1-3 & ORD$\to$LAX & 40 & 1 & 46.780 & 570.110 & 0.08x \\
\midrule

% Dataset B2
B2-1 & DFW$\to$ORD & 40 & 1 & 62.110 & 1120.780 & 0.06x \\
B2-2 & DFW$\to$DCA & 40 & 1 & 153.420 & 1463.250 & 0.10x \\
B2-3 & ATL$\to$SEA & 40 & 0 & 28.500 & 29.600 & 0.96x \\
\midrule

% Dataset B3
B3-1 & DFW$\to$ORD & 40 & 3 & 18.640 & 828.130 & 0.02x \\
B3-2 & DFW$\to$DCA & 40 & 3 & 83.560 & 1187.400 & 0.07x \\
B3-3 & ORD$\to$MIA & 40 & 1 & 80.660 & 606.690 & 0.13x \\
\midrule

% Dataset C1 (100 vuelos)
C1-1 & ORD$\to$TPA & 100 & 3 & 7653.230 & 8273.470 & 0.93x \\
C1-2 & DFW$\to$MIA & 100 & 3 & 6482.580 & 7394.100 & 0.88x \\
C1-3 & ATL$\to$LAX & 100 & 2 & 2491.040 & 6598.870 & 0.38x \\
\midrule

% Dataset C2
C2-1 & ORD$\to$TPA & 100 & 2 & 7415.010 & 5199.010 & 1.43x \\
C2-2 & LAX$\to$JFK & 100 & 0 & 2554.430 & 2090.370 & 1.22x \\
C2-3 & SEA$\to$MIA & 100 & 1 & 7265.910 & 5494.240 & 1.32x \\
\midrule

% Dataset C3
C3-1 & ORD$\to$TPA & 100 & 1 & 7153.090 & 7425.850 & 0.96x \\
C3-2 & DFW$\to$SEA & 100 & 9 & 8756.110 & 4236.580 & 2.07x \\
C3-3 & ATL$\to$SFO & 100 & 1 & 5173.830 & 3761.960 & 1.38x \\

\end{longtable}

\paragraph{Análisis de Resultado}
En resumen, los resultados permiten identificar un patrón claro: cuando el número de itinerarios es bajo, el sobrecosto de la paralelización hace que la versión secuencial sea más eficiente; cuando el número de itinerarios crece y el problema se vuelve más costoso (datasets del grupo C), la versión paralela comienza a ofrecer mejoras significativas en tiempo de ejecución. De este modo, la pertinencia de paralelizar la función \texttt{itinerarios} depende directamente de la magnitud del espacio de búsqueda (cantidad de itinerarios posibles) para una ruta dada.

La tabla anterior presenta el tiempo de ejecución de la versión secuencial y la versión paralela de la función \texttt{itinerarios} para distintos conjuntos de datos, variando el número de vuelos y la cantidad de itinerarios. El \textbf{Speedup} (cociente entre el tiempo secuencial y el paralelo) revela la siguiente tendencia:

\begin{enumerate}
    \item \textbf{Datasets Pequeños (Curso y A, 15--16 vuelos):} La versión paralela es significativamente más lenta que la secuencial. En la mayoría de los casos (e.g., A1-1: 0.02x, Curso-A3: 0.06x), el \emph{speedup} está $\mathbf{\ll 1}$. Esto se debe al \textbf{overhead de la paralelización}: el costo de inicializar el paralelismo, dividir el trabajo y recolectar los resultados es mucho mayor que el tiempo que tarda la versión secuencial en encontrar las rutas, especialmente cuando solo se encuentra $1$ o $2$ itinerarios. La única excepción notable es el caso A2-2 (0 itinerarios), donde la versión paralela es ligeramente mejor (1.41x), posiblemente debido a una optimización no intencional en la gestión del paralelismo en rutas sin salida.
    \item \textbf{Datasets de Tamaño Medio (Grupo B, 40 vuelos):} El patrón de ineficiencia se mantiene. En la mayoría de los casos (e.g., B3-1: 0.02x, B1-2: 0.17x), el \emph{speedup} sigue siendo $\mathbf{< 1}$, confirmando que para volúmenes de trabajo moderados o bajos, el sobrecosto domina.
    \item \textbf{Datasets Grandes (Grupo C, 100 vuelos):} La situación es mixta, pero se observan ganancias cuando el trabajo es lo suficientemente grande.
    \begin{itemize}
        \item En la mayoría de los casos del grupo C (e.g., C1-1: 0.93x, C3-1: 0.96x), el \emph{speedup} se mantiene cerca o justo por debajo de $\mathbf{1\times}$.
        \item Sin embargo, la versión paralela demuestra ser superior en varios escenarios (C2-1: 1.43x, C2-2: 1.22x, C2-3: 1.32x, y C3-2: 2.07x). Esto indica que, a medida que la exploración del árbol de búsqueda se vuelve más costosa (T. secuencial supera los 5000 ms), el paralelismo de tareas logra distribuir eficientemente la carga entre los núcleos, superando el costo fijo inicial y ofreciendo una mejora significativa en el tiempo de ejecución total, alcanzando un máximo de $\mathbf{2.07\times}$ en el caso C3-2.
    \end{itemize}
\end{enumerate}
En conclusión, la versión paralela solo ofrece una ventaja de rendimiento cuando el \textbf{tiempo de cómputo secuencial es elevado (varios segundos)}, lo que ocurre en los \textbf{datasets grandes} del grupo C, demostrando la importancia de equilibrar el \textit{overhead} de la paralelización con la magnitud del trabajo a realizar.
